...
_csv_writers: Dict[str, csv.DictWriter] = {}                # ← CHANGED
...
def _get_csv_writer(file_path: str, headers: List[str], step: int) -> csv.DictWriter:   # ← CHANGED
...
def _flush_buffer(file_path: str) -> None:
    if file_path in _data_buffers and _data_buffers[file_path]:
        writer: csv.DictWriter = _csv_writers[file_path]          # ← CHANGED
