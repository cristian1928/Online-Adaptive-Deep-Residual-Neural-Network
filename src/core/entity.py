...
class Agent(Entity):
    ...
    def _input_func(self, step: int) -> NDArray[np.float64]: 
    ...
    def update_dynamics(self, step: int) -> None: 
        def control_wrapper(t: float, y: Union[NDArray[np.float64], float]) -> Union[NDArray[np.float64], float]:
...
class Target(Entity):
    ...
    def update_dynamics(self, step: int) -> None: 
        def dynamics_wrapper(t: float, pos: Union[NDArray[np.float64], float]) -> Union[NDArray[np.float64], float]:
